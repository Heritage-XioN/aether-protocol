...
//! Autogenerated weights for aether_pallet_template
//!
...
/// Weight functions needed for aether_pallet_template.
pub trait WeightInfo {
	fn do_something() -> Weight;
	fn cause_error() -> Weight;
}

/// Weights for aether_pallet_template using the Substrate node and recommended hardware.
